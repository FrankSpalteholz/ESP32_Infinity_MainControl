...
// CDisplay lcd = CDisplay();
// //CLed_Quad ledStripQuads = CLed_Quad();
...
// void updateLEDData(uint8_t quadNum, uint8_t stripNum, int direction);
...
//     //         ledStripQuads.showStripsColors();
//     //         FastLED.show();
//     //     }
//     // }
...
//     // ledStripQuads.ledStripData[quadNum][stripNum].dotDir = direction;
//     // ledStripQuads.ledStripData[quadNum][stripNum].hsvVals[2] = ledPlayer.brightness;
