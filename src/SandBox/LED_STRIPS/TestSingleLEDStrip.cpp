...
// CRGB leds_inside[LEDS_PER_STRIP_COUNT];
// CRGB leds_outside[LEDS_PER_STRIP_COUNT];
...
//   FastLED.addLeds<NEOPIXEL, LED_PIN_A1>(leds_A1, LEDS_PER_STRIP_COUNT);
//   FastLED.addLeds<NEOPIXEL, LED_PIN_A2>(leds_A2, LEDS_PER_STRIP_COUNT);
//   FastLED.addLeds<NEOPIXEL, LED_PIN_A3>(leds_A3, LEDS_PER_STRIP_COUNT);
//   FastLED.addLeds<NEOPIXEL, LED_PIN_A4>(leds_A4, LEDS_PER_STRIP_COUNT);
//   FastLED.addLeds<NEOPIXEL, LED_PIN_B1>(leds_B1, LEDS_PER_STRIP_COUNT);
//   FastLED.addLeds<NEOPIXEL, LED_PIN_B2>(leds_B2, LEDS_PER_STRIP_COUNT);
//   FastLED.addLeds<NEOPIXEL, LED_PIN_B3>(leds_B3, LEDS_PER_STRIP_COUNT);
//   FastLED.addLeds<NEOPIXEL, LED_PIN_B4>(leds_B4, LEDS_PER_STRIP_COUNT);
